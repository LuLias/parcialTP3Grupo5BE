...
class OfferPreviewAdapter(var offerList: List <OfferModel>) : RecyclerView.Adapter<OfferViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OfferViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return OfferViewHolder(layoutInflater.inflate(R.layout.offers_preview_item, parent,false))
    }
